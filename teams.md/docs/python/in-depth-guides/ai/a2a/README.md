...
-   **A2A Client**: Allows your Teams app to proactively reach out to other A2A servers as a client, either through direct usage or integrated with `ChatPrompt` for LLM-driven interactions.
