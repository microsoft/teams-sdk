...
```
teams app rsc set <teamsAppId> --permissions <list>
```
...
| Option | Description |
|--------|-------------|
| `--permissions <list>` | Comma-separated permission names (e.g. TeamSettings.ReadWrite.Group,ChannelMessage.Read.Group). Use `""` to clear all permissions |
