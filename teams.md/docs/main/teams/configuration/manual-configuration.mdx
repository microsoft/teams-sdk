...
:::tip
We are using Client Secrets authentication here, but it is possible to use other types of authentication as described in [App Authentication](../app-authentication.md).
:::
