...
:::tip
We are using Client Secrets authentication here, but it is possible to use other types of authentication as described in App Authentication page.
:::
...
- [Official Teams App Publishing overview](https://learn.microsoft.com/en-us/microsoftteams/platform/concepts/deploy-and-publish/apps-publish-overview)
