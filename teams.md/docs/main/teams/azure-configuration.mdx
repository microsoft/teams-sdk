...
Once the Azure Bot resource exists, point it at your public HTTPS endpoint. Use [DevTunnels or ngrok](/developer-tools/local-tunnels) to expose your local server during development.
