---
sidebar_position: 3
summary: Set up an Entra App Registration and Azure Bot Service resource for production Teams bot apps.
---
...
For production and enterprise setups, you may need full control over your Azure resources rather than using the Teams CLI's automated path. This guide walks through creating an Entra App Registration and Azure Bot Service resource manually.
...
:::tip Using the Teams CLI instead?
For local development and prototyping, `teams app create --azure` handles this automatically. See [Quickstart: Register your app](../get-started/quickstart-register.md).
:::
