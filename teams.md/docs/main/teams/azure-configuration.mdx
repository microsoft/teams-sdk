...
Or use the [`teams-dev` agent skill](/cli/getting-started/agent-skills) — tell your AI assistant to set up your Teams bot and it handles everything automatically.
