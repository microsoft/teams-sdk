...
The [`teams-dev` skill](/developer-tools/agent-skills) can orchestrate the full SSO setup for you — install it in your AI coding assistant and say *"set up SSO for my Teams bot"*.
:::
