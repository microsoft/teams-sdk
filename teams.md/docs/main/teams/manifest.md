...
The Teams CLI handles sideloading automatically — see [Quickstart: Register your app](../get-started/quickstart-register) for the full walkthrough. To upload a manifest directly, use `teams app manifest upload`.
