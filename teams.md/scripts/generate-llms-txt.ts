...
async function processAllFiles(
  allFiles: string[],
  baseDir: string
): Promise<{ processedFiles: ProcessedFile[]; fileMapping: Map<string, string> }> {
 ...
 */
async function generateSmallVersionHierarchical(
  language: Language,
  baseDir: string,
  config: DocusaurusConfig,
  fileMapping: Map<string, string>
  ...
  content += renderHierarchicalStructure(
 ...
 */
function renderHierarchicalStructure(
 ...
 */
function groupFilesBySection(
  processedFiles: ProcessedFile[],
  baseDir: string
): { [key: string]: ProcessedFile[] } {
