...
:::info[Teams SDK 2.1 Preview now available]
A preview of **Teams SDK 2.1 for .NET** is now available. It brings three headline changes:
...
You'll find **SDK 2.0 / SDK 2.1** tabs throughout this guide wherever the two versions differ. For the full overview, read the [Teams SDK for .NET 2.1 Preview announcement](/blog/announcing-teams-sdk-dotnet-2-1-preview), or jump straight to the [TeamsBot sample](https://github.com/microsoft/teams.net/tree/main/core/samples/TeamsBot).
:::
