...
such as `on_members_added_activity` or `on_message_activity`, to handle different activity types.
...
- `app.py` sets up a Teams SDK `app` and registers the `BotBuilderPlugin` with your adapter and activity handler.
