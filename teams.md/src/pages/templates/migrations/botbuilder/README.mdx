...
- [Integration](integration) — set up the BotBuilder plugin alongside the Teams SDK App
- [Sending Activities](sending-activities) — send messages and replies using BotBuilder adapters
- [Proactive Activities](proactive-activities) — send proactive messages with the compatibility plugin
- [The API Client](the-api-client) — use the Teams SDK API client within BotBuilder apps
- [User Authentication](user-authentication) — add user auth to your migrated BotBuilder app
