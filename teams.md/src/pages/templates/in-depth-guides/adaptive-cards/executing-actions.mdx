...
Just like when building cards, if you prefer to work with raw JSON, you can do just that. <LanguageInclude content={{"typescript": "You get type safety for free in TypeScript.", "python": "You get type safety for free in Python."}} />
