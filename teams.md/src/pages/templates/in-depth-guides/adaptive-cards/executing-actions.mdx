...
The recommended approach is to register handlers for specific actions. When you use `SubmitData` to set the action name on the card, you can route directly to a handler for that action:
