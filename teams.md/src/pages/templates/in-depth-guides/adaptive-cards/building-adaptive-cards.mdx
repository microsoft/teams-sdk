...
The package bundles the **Adaptive Card v1.5 schema** as strict <LanguageInclude content={{"typescript": "TypeScript/JavaScript", "csharp": "C#", "python": "Python"}} /> types.
...
This method leverages the full Adaptive Card schema and ensures that the payload adheres strictly to <LanguageInclude content={{"typescript": "`IAdaptiveCard`", "csharp": "`AdaptiveCard`", "python": "`AdaptiveCard`"}} />.
