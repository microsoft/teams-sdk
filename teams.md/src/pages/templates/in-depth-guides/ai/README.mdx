...
- [Setup & Prerequisites](setup-and-prereqs) — install packages and configure your LLM provider
- [Chat](chat) — build conversational agents with prompt orchestration
- [Function Calling](function-calling) — give your agent tools to act on the world
- [MCP](mcp) — connect your agent to MCP servers
