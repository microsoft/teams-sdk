...
:::warning
User authentication does not work with the developer tools setup. You have to run the app in Teams. Follow these [instructions](/main/typescript/getting-started/running-in-teams#debugging-in-teams) to run your app in Teams.
:::
...
:::note
This uses the Single Sign-On (SSO) authentication flow. To learn more about all the available flows and their differences see the [How Auth Works](/teams/user-authentication/auth-sso) guide.
:::
