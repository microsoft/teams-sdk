...
:::warning
User authentication does not work with the developer tools setup. You have to run the app in Teams. Follow the [Running in Teams](../getting-started/running-in-teams#debugging-in-teams) guide to get your app running in Teams first.
:::
