...
A common pattern is to store the original message before initiating sign-in, then retrieve and process it in the sign-in success handler. This avoids confusing exchanges where the bot ignores what the user originally asked.
