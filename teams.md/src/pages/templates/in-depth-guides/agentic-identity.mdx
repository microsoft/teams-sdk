...
:::info[SDK 2.1]
Agentic identity is a **Teams SDK for .NET 2.1** feature. See the [2.1 announcement](/blog/announcing-teams-sdk-dotnet-2-1#agentic-identity) for the full overview.
:::
