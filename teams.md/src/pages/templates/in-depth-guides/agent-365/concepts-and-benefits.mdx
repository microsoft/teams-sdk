...
sidebar_position: 1
summary: Understand Agentic Blueprint IDs, Agentic App Instances, Agentic Users, and the benefits of Agent 365.
...
Teams SDK provides the Activity Protocol and identity-aware messaging layer for Agentic Users in Teams. One reusable blueprint runtime can serve multiple app instances and Agentic Users while the SDK preserves the correct identity for messages, API calls, lifecycle events, and telemetry.

## Identity model

| Concept                      | Purpose                                                                                                                                              |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Agentic Blueprint ID**     | Identifies the reusable application, credentials, permissions, and runtime that define an agent.                                                     |
...
```mermaid
flowchart LR
  B[Agentic Blueprint ID<br/>shared code and credentials]
...
## How Agentic Users Compare to a Standard Bot
