...
For .NET SDK version targeting:

- **SDK 2.0**: use stable CLI (`@microsoft/teams.cli`)
- **SDK 2.1 (Preview)**: use preview CLI (`@microsoft/teams.cli@preview`)
...
<LanguageInclude section="post-startup-explanation" />
...
<LanguageInclude section="local-test-link" />
