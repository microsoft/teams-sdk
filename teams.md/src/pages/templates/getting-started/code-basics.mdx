...
Now that you understand the basic structure of your Teams application, you're ready to [run it in Teams](running-in-teams). You will learn how to register your app and get it running in Teams for testing.
