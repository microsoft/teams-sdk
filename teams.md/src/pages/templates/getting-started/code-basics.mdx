...
Plugins are a core part of the Teams SDK. They allow you to hook into various lifecycles of the application. The lifecycles include server events (start, stop, initialize, etc.), and also Teams Activity events <LanguageInclude section="plugin-events" />.

<LanguageInclude section="local-test-note" />
