...
- A public HTTPS tunnel pointing at your local server — see [Local Tunnels](/developer-tools/local-tunnels) if you haven't set one up yet
...
<LanguageInclude section="local-test-tip" />

## Troubleshooting

- Run `teams app doctor` against your app to surface configuration issues.
- Tunnel returning `502` or Teams can't reach your bot? See [Local Tunnels](/developer-tools/local-tunnels#troubleshooting).
