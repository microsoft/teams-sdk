...
| ---------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Teams SDK CLI                | `teams` | A command-line tool for setting up and utilizing the Teams SDK library, including integration with Microsoft 365 Agents Toolkit when desired. |
...
For deployment and resource management we recommend the Microsoft 365 Agents Toolkit. Refer to our [Deployment guide](./deployment-guide) for common scenarios and potential issues.
