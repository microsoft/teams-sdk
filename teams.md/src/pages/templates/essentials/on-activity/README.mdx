...
:::note[SDK 2.0 (Legacy)]
In SDK 2.0, activity handlers formed a chain: if you stopped it by not calling `next()`, the activity was not passed to the next handler, and the order of registration determined how handlers were called.
:::
