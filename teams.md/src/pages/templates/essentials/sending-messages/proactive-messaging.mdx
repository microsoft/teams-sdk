...
Targeted proactive messages are currently in preview and only available in C#.
:::

You can also send [targeted messages](./#targeted-messages-preview) proactively to deliver private message to specific user in a conversation.
