...
The SDK automatically configures all authentication endpoints for the specified cloud. No other changes are needed. See the [Sovereign Cloud](/teams/app-authentication/sovereign-cloud) guide for details and programmatic configuration options.

<LanguageInclude section="sovereign-cloud-overrides" />
