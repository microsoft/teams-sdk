...
- [Listening to Events](on-event) — subscribe to user and server events
- [Listening to Activities](on-activity) — handle Teams-specific messages, card actions, and installs
- [Sending Messages](sending-messages) — reply, stream, mention, and send targeted messages
